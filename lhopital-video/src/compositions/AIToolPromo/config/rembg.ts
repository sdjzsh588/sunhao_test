...
export const rembgV4: AIToolConfigV3 & {
  ...
  voiceover: [
    ...
    {
      id: "03-usage",
      tts: "不懂技术也能装，就三步：第一步，去 python 点 org 官网下载 Python，一路点下一步装上；第二步，打开命令行——Windows 按 Win 键加 R，输入 c m d 回车，苹果电脑直接搜索终端；第三步，把屏幕上这行命令原样粘贴进去，回车，等它装完。装好之后，抠图就这一行。那它怎么知道你的图片在哪？最简单：先打 rembg i 加个空格，然后把照片直接拖进这个窗口，文件位置自动就填上了，再写个输出名，回车搞定。",
    },
    {
      id: "04-beat1",
