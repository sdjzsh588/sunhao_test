...
export const napkinV3: AIToolConfigV3 = {
  ...
  voiceover: [
    ...
    { id: "03-step1", tts: "第一步，把你的文案，或者整个文件，直接粘进去。" },
    { id: "04-step2", tts: "第二步，点一下蓝色小闪电，它就会根据你的内容，生成几种不同风格的配图，你挑一张最满意的就行。" },
    { id: "05-step3", tts: "第三步，颜色、风格、每一个元素都能自定义，随手改成你要的样子。" },
    { id: "06-step4", tts: "第四步，选好导出格式，P P T、P N G、P D F、S V G 都支持。" },
