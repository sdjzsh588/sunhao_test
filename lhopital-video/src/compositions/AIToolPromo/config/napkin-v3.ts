...
export const napkinV3: AIToolConfigV3 = {
  ...
  voiceover: [
    ...
    { id: "03-step1", tts: "第一步，从笔记、文档、任何地方，粘一段文字进来就行。" },
    { id: "04-step2", tts: "第二步，点一下那个闪电按钮，AI 就自动帮你生成一张信息图。" },
    { id: "05-step3", tts: "第三步，几十种风格随便挑，字体、配色、布局都能一键切换。" },
    { id: "06-step4", tts: "第四步，做好的图能导出多种格式，公众号、P P T、小红书都能直接用。" },
